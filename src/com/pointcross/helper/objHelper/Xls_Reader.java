...
public class Xls_Reader extends BaseUtil {
...
//		
//		int rows=BaseClass.datatable.getRowCount(sheetName)-1;
//		if(rows <=0){
//			Object[][] testData =new Object[1][0];
//			return testData;
//			
//		}
//	    rows = BaseClass.datatable.getRowCount(sheetName);  
//		int cols = BaseClass.datatable.getColumnCount(sheetName);
...
//				data[rowNum-2][colNum]=BaseClass.datatable.getCellData(sheetName, colNum, rowNum);
//			}
//		}
//		
//		return data;
...
//		try {
//			
//			for(int i=2; i<=BaseClass.datatable.getRowCount("Test Cases"); i++ )
//			{
//		    	  if(BaseClass.datatable.getCellData("Test Cases", "TCID", i).equalsIgnoreCase(testCase)){
//		    		  if(BaseClass.datatable.getCellData("Test Cases", "Runmode", i).equalsIgnoreCase("Y"))
//		    			  return false;
//		    		  else
//		    			  return true;
//		    	  }
...
//			
//		} catch (Exception e) {
//			Reporter.log("General exception occured in function isSkip in Xls_Reader class");
//			e.printStackTrace();
//			return false;
//		}
//		
//	}
	...
	public static boolean isSkip(String testCase){
		try {
			...
			for(int i=2; i<=BaseUtil.datatable.getRowCount("Test Cases"); i++ )
			{
		    	  if(BaseUtil.datatable.getCellData("Test Cases", "TCID", i).equalsIgnoreCase(testCase)){
		    		  if(BaseUtil.datatable.getCellData("Test Cases", "Runmode", i).equalsIgnoreCase("Y"))
		    			  return false;
		    		  else
		    			  return true;
		    	  }
